...
| Avec **full** fatiado | ops = P1/P2/P3 · agenda = +21d (Contatos +7d) · catalog = 0004 | `/api/avec/sync/full/{ops,agenda,catalog}` — 2×/dia (10h/22h); retry on-demand (min-gap), sem cron horário |
