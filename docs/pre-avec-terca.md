...
- [ ] Push `cerebro-rom` (leitura P1/P2/P3 + merge #10–14)
- [ ] Push `ROM` + `ROM-IGUATEMI` (sync realtime webhook + cron full 10 min)
- [ ] Confirmar produção: cerebro-rom.vercel.app, rom-club, rom-iguatemi
- [ ] Login Waltter no Cérebro OK
- [ ] Badge **Degradado** ou **Live parcial** — nunca mock falso em prod
