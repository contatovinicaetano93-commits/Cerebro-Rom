...
const COMPARISON_LEGEND: Partial<Record<string, string>> = {
  ...
  payments_total: 'Soma das formas de pagamento (Avec 0081) nos dias sincronizados.',
  payment_gap: '0081 − receita só nos dias com as duas séries (ideal ≈ 0).',
  payment_reconcile: 'Conciliação 0081 vs receita no overlap de dias (tolerância 1%).',
